...
class CommunityManageService:
    ...
    @staticmethod
    async def get_community_for_chat(chat_db: ChatModel, *, services: ApplicationServices) -> CommunityModel | None:
        ...
        ref = await fetch_chat_community(chat_db.tid, bot=services.bot, redis=services.redis)
        if ref is None:
            return None
