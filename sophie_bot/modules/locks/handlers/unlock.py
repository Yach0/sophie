...
class UnlockHandler(BaseLockToggleHandler):
    ...
    usage_hint: ClassVar[str] = l_("Use /locks to see currently locked types.")
    filters_module_text: ClassVar[str] = l_("Lock type {type} is enforced by the Filters module, not Locks.")
    filters_module_delete_hint: ClassVar[str] = l_("Delete it there with {cmd} if you want to stop enforcing it.")
    success_title: ClassVar[str] = l_("Lock removed")
    already_state_text: ClassVar[str] = l_("Lock type {type} is not locked in this chat.")
